<?php
  $apiKey="Your Whois API 2.0 API key";
  $contents = file_get_contents("http://www.whoisxmlapi.com//whoisserver/WhoisService?domainName=google.com&apiKey=$apiKey&outputFormat=JSON");
  //echo $contents;
